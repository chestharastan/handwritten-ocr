...
- `lines/<id>.png`: grayscale line crops, 128 px high
...
- Training uses AdamW with warmup and cosine decay, label smoothing of 0.1, dropout 0.2, and augmentation (slant, rotation, baseline wave, stretch, margins, contrast, blur, stroke thickness and noise).
